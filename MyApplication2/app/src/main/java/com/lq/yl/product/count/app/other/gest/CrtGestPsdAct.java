...
import com.lq.yl.product.count.app.other.gest.view.LockPatternView.DisplayMode;

import java.util.ArrayList;
import java.util.List;

public class CrtGestPsdAct extends BaseAct implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.crt_gest_psd_act_layout);
		// 初始化演示动画
	...
	private void saveChosenPatternAndFinish() {
		ProductApp.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
		showToast("密码设置成功");
		if (new StoreProDao(CrtGestPsdAct.this).getCount() == 0) {
			startActivity(new Intent(CrtGestPsdAct.this, CrtStoreAct.class));
		} else if (new ProductDao(CrtGestPsdAct.this).getCount() == 0) {
			startActivity(new Intent(CrtGestPsdAct.this, CrtProAct.class));
		} else {
			startActivity(new Intent(CrtGestPsdAct.this, MainAct.class));
		}
	}
}
